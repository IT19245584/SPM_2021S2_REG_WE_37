            ...
            if (this.state.date_modified === false && this.state.file_modified === false) {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        axios.put(global.APIUrl+'/assessments/' + this.props.match.params.id, currentAssignment)
                            .then(() => {
                                Swal.fire({
                                    ...
                                    if (result.value) {
                                        this.props.history.push('/lecturer/assessments/' + this.props.match.params.id);
                                    }
                                });
                ...
                if (this.state.file.size <= fileSize) {
                    ...
                    axios.post(global.APIUrl+'/assessments/upload-file', fd, {
        ...
        return (
            <div>
                ...
                <div className="container">
                    <div className="card col-md-8 offset-2 mt-3">
