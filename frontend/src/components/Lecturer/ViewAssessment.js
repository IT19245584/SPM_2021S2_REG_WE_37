                ...
                <div className="container mt-3">
                    <div className="card">
                        <div className="card-header">
                            ...
                            <Link to={"/lecturer/assessments/" + this.state.assessment._id + "/edit"}>
                                <input type="button" value="Edit" className="btn btn-success float-right d-inline "/>
                            </Link>
                        ...
                        <div className="input-group mx-2 mb-3">
                            ...
                            href={global.APIUrl+'/'+this.state.assessment.file_url}
                            download>
