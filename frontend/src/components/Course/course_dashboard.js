        ...
        <MDBNavbar expand='lg' className="sticky-top" light bgColor='dark'>
            <MDBContainer fluid>
                ...
                <MDBNavbarNav className='mr-auto mb-2 mb-lg-0'>
                    <MDBNavbarItem>
                    <MDBNavbarLink style={{color: '#DCDCDC'}} active aria-current='page' href='/course'>
                    Courses
                    </MDBNavbarLink>
                    </MDBNavbarItem>
                    ...
                    <MDBNavbarItem>
                    <MDBNavbarLink href='/lesson' tabIndex={-1} aria-disabled='true' style={{color: '#DCDCDC', cursor: 'pointer'}}>
                        Lessons
                    </MDBNavbarLink>
                    </MDBNavbarItem>
                     <MDBNavbarItem>
