...
class StudentRegister extends Component {
    ...
    onSubmit = e => {
        ...
        if (this.validate()) {
            ...
            axios.post(global.APIUrl+'/students/register', newStudent)
                .then(res => {
    ...
    render() {
        return (
            ...
            <MDBCol sm='5'  style={{marginTop:'0%'}}>
                <MDBCard className="border-0 shadow-0">
                <MDBCardBody className="pt-5 mt-3 text-left">
                   <div className="bg-light p-4">
                     <center><h2 className="text-uppercase">Sing Up (Teacher)</h2></center>
                     <br/>
                    <div class="mb-3">
                   ...
                   <br/>
                    ...
                    <div class="mb-3">
                     ...
                     <div className="text-center mt-3">
                            ...
                            <Link to="/login" className="alert-link mr-5"><a href="/login"> Sign In</a></Link>
                        </div>
