...
export default function UpdateTechnicalCommittee() {
    ...
    function updateProfile(e) {
        ...
        axios.post("http://localhost:5000/Profile/updateTechnicalCommittee/" + id, newTechnicalCommittee).then(() => {
    ...
    return (
        <div>
            ...
            <div className="d-flex p-2" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
                <h1 tag='div' className='display-1 pb-3 mb-3 border-bottom'>Update Student Profile</h1>
            </div>
            <div className="col-md-14 col-sm-12" style={{ maxWidth: '70rem', margin: 'auto', padding: '10px' }}>
                <div className="row g-0">
                   ...
                   {/* <div className="form-outline mb-4">
                        ...
                        <input type="file" onChange={(e) => { setImage(e.target.files[0]) }} className="form-control" id="customFile" required />

                    </div> */}
                    <div className="form-outline mb-4">
                    Major: <input type="text" id="department" className="form-control border border-dark mb-3" name="department" value={department} onChange={(e) => { setDepartment(e.target.value) }} required />

                    </div>
                    <div className="form-outline mb-4">
                        About: <textarea className="form-control border border-dark mb-3" id="description" rows="4" name="description" value={description} onChange={(e) => { setDescription(e.target.value) }} required />
