...
export default function ExamDetails() {
  ...
  return (
    <div>
          <Header/>
          <br/>
           <h2 style={{display: 'flex',  justifyContent:'center', alignItems:'center',height:"60px"}}>Register for Semester examination</h2>
                <div className="col-sm-6 p-3 bg-light" className="center" style={{marginLeft:'30%',marginRight:'30%'}}>
                  <div class="mb-3">
                  <label class="form-label">Registration No. <sup className="text-danger" style={{fontSize:'10px'}}>*Required</sup></label>
                  ...
                  <div className="mb-3">
                            <label className="form-label">Lesson Name <sup className="text-danger" style={{fontSize:'10px'}}>{Required}</sup></label>
                  ...
                  <div class="mb-3">
                  <label className="form-label">Exam Date <sup className="text-danger" style={{fontSize:'10px'}}>{Required}</sup></label>
                    <div className="input-group">
                  ...
                  <div className="mb-3">
                            <label className="form-label">Exam Session <sup className="text-danger" style={{fontSize:'10px'}}>{Required}</sup></label>
                            <select class="form-select" aria-label="Default select example"  onChange={(e) =>{
                  ...
                  <div class="mb-3">
                    <label class="form-label">Amout <sup className="text-danger" style={{fontSize:'10px'}}></sup></label>
                    <div className="input-group">
