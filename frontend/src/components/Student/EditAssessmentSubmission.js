...
class EditAssessmentSubmission extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(global.APIUrl+'/submissions/' + this.props.match.params.id)
            .then(response => {
                ...
                document.getElementById('due_date').innerHTML = moment(response.data.due_date).format('dddd, Do MMMM YYYY');
            ...
            if (this.state.date_modified === false && this.state.file_modified === false) {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        axios.put(global.APIUrl+'/submissions/' + this.props.match.params.id, currentAssignment)
                            .then(() => {
                                Swal.fire({
                ...
                axios.put(global.APIUrl+'/submissions/' + this.props.match.params.id, currentAssignment)
                    .then(() => {
                        Swal.fire({
                            ...
                            if (result.value) {
                                this.props.history.push('/submissions/assessment' + this.props.match.params.id);
                            }
                        });
                ...
                if (this.state.file.size <= fileSize) {
                    ...
                    axios.post(global.APIUrl+'/submissions/upload-file', fd, {
                        ...
                        .then(res => {
                            if (res.data.status !== 400) {
                                ...
                                axios.post(global.APIUrl+'/submissions/delete-file', deleteFile);
                ...
                <div className="container col-md-8 offset-2 mt-3">
                    <div className="card">
                        <form onSubmit={this.handleUpdateSubmit}>
                            ...
                            <div className="form-group mx-sm-2 ml-2 mr-2 d-none">
                                <label className="ml-1">Due Date:</label>
                                <label className="form-control bg-light" id="due_date">Due Date</label>
                            </div>
...
export default EditAssessmentSubmission;