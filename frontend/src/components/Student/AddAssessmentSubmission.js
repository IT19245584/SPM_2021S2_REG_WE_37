...
class AddAssessmentSubmission extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(global.APIUrl+'/assessments/' + this.props.match.params.id)
            .then(response => {
                this.setState({
        ...
        axios.get(global.APIUrl+'/submissions/assessment/' + this.props.match.params.id + '/' + sessionStorage.getItem('userId'))
            .then(response => {
                this.setState({
    ...
    render() {
        return (
            ...
            <div className="container col-md-8 offset-2 mt-5">
                ...
                <div className="card">
                    ...
                    <div className="input-group mx-2 mb-3">
                        ...
                        <a id="assigned_doc" className="form-control alert-link mr-3"
                           href={global.APIUrl+'/'+this.state.assessment.file_url} download>
...
export default  AddAssessmentSubmission;