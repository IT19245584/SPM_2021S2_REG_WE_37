    ...
    <div class="dashboard-main-wrapper" >
        ...
        <div className="dashboard-wrapper" style={{paddingBottom:'5%'}}>
            <div className="container" style={{paddingTop:'3%',paddingLeft:'2%', width:'98%'}}>
                <h4 className="text-uppercase  d-letter-spacing fw-bold" style={{color:'black'}}><i className="fas fa-home"></i> Create - <span style={{color:'#424242'}}>Receive Materials</span></h4>
                <hr/>
                <br/>
                <div className="text-end mb-2">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-header border-0 bg-dark">
                            <span class="modal-title text-warning" style={{fontWeight: '400',fontSize:'18px'}} id="staticBackdropLabel">Create - Receive Bin Allocation</span>
                        ...
                        <div class="modal-body m-2 text-left">
                            ...
                            <div className="mb-3">
                                <div className="row">
                                        <div className="col">
                                            <label for="exampleFormControlInput1" class="form-label mt-0 mb-0">Allocated Rack</label>
